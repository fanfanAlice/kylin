...
public class EngineFactory {
    ...
    public static DefaultChainedExecutable createSampleTableJob(String project, String submitter, long maxSampleCount, String tableName) {
        return batchEngine().createSampleTableJob(project, submitter, maxSampleCount, tableName);
    }
}
